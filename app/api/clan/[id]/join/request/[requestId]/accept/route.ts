...
import { acceptJoinRequest, getRequest } from "@/data-access/clan-join-request";
...
export const POST = async (
  ...
  try {
    ...
    const [acceptError, acceptedJoinRequest] = await acceptJoinRequest({
